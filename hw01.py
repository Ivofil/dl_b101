...
my_age_dif = my_age - 18
if my_age_dif > 0:
    print(my_name,' на ',my_age_dif,'года/лет старше 18')
else:
    print(my_name,' на ',-my_age_dif,'года/лет младше 18')
...
num1 = sum_num - num1
num2 = sum_num - num1
print('Первая: ',num1,', вторая: ',num2)


numero1 = int(input('Введите первую переменную: '))
numero2 = int(input('Введите вторую переменную: '))
numero_new = numero1
numero1 = numero2
numero2 = numero_new
print('Первая: ',numero1,', вторая: ',numero2)
